...
use ola_core::prompt::{self, PromptResult};
use std::env;
...
fn test_structure_reasoning_openai() {
    ...
    let result = prompt::structure_reasoning_test("Test prompt", "text", "", false, None, false);
...
fn test_stream_non_think_openai() {
    ...
    // Call the function under test
    let result = prompt::stream_non_think_test("Test prompt", false, None, false);
