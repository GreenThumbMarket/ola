...
pub fn format_prompt(
    ...
    if let Some(ctx) = context {
        format!(
            "{}{}\n{}{}\n{}{}\nContext: {}",
            goals_prefix, goals, return_format_prefix, return_type, warnings_prefix, warnings, ctx
        )
    } else {
        format!(
            "{}{}\n{}{}\n{}{}",
            goals_prefix, goals, return_format_prefix, return_type, warnings_prefix, warnings
        )
    }
}
